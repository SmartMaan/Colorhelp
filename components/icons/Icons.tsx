...
export const BroomIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M19.4 12.6a4 4 0 0 0-5.6 5.6l-5.6 5.6a1 1 0 0 1-1.4 0l-1.4-1.4a1 1 0 0 1 0-1.4Z"></path>
        <path d="m21 5-3.4 3.4"></path>
        <path d="m15 11-3.4 3.4"></path>
        <path d="M12.6 19.4a4 4 0 0 0 5.6-5.6Z"></path>
        <path d="M10 14 5 19"></path>
        <path d="M5 21v-3h3"></path>
    </svg>
);
